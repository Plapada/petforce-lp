...
export default function Hero() {
  return (
    <section className="relative min-h-[100dvh] w-full flex flex-col items-center justify-center px-4 md:px-8 overflow-hidden">
      {/* Noise */}
      ...
      {/* Ambient glows */}
      <div className="absolute top-[15%] -left-[10%] w-[600px] h-[600px] bg-accent-1/5 blur-[200px] rounded-full pointer-events-none" />
      <div className="absolute bottom-[10%] -right-[10%] w-[500px] h-[500px] bg-accent-3/5 blur-[180px] rounded-full pointer-events-none" />
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-5xl mx-auto">
        ...
        >
          <span className="gradient-text-animated text-2xl md:text-4xl font-bold uppercase tracking-[0.2em] font-sora drop-shadow-[0_0_30px_rgba(57,255,20,0.3)]">
            PetForce
          </span>
        </motion.div>
        ...
        {/* Headline */}
        <motion.h1
          className="font-sora text-[clamp(2.5rem,8vw,7rem)] font-normal tracking-[-0.04em] leading-[0.92] mb-8"
        ...
        {/* Subheadline */}
        <motion.p
          className="text-lg md:text-xl text-white/50 font-light leading-relaxed max-w-2xl mb-6"
        ...
        >
          <div className="flex -space-x-2">
            <div className="w-8 h-8 rounded-full gradient-border flex items-center justify-center text-[10px] font-bold text-black">80+</div>
          </div>
        ...
        >
          ...
          <a
            ...
            className="group relative overflow-hidden flex items-center gap-4 pl-8 pr-2 py-2 rounded-full transition-all"
          ...
          >
            ...
            <span className="relative z-10 text-sm md:text-base font-sora font-medium text-white group-hover:text-accent-2 transition-colors" style={{ transitionDuration: "300ms" }}>
              Quero mais clientes
            </span>
            <span className="relative z-10 w-10 h-10 rounded-full gradient-border flex items-center justify-center shrink-0">
          ...
          <a
            href="#servicos"
            className="px-6 py-3 text-[11px] uppercase tracking-[0.2em] font-bold text-white/40 hover:text-white transition-colors border border-white/10 rounded-full hover:border-white/20"
